    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shipments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('discharging_port') ? 'is-invalid' : '' }}" name="discharging_port_id" id="discharging_port_id">
                    @foreach($discharging_ports as $id => $entry)
                        <option value="{{ $id }}" {{ old('discharging_port_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_arrival_1') ? 'is-invalid' : '' }}" type="text" name="date_of_arrival_1" id="date_of_arrival_1" value="{{ old('date_of_arrival_1') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_arrival_2') ? 'is-invalid' : '' }}" type="text" name="date_of_arrival_2" id="date_of_arrival_2" value="{{ old('date_of_arrival_2') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('loading_rate_value') ? 'is-invalid' : '' }}" type="text" name="loading_rate_value" id="loading_rate_value" value="{{ old('loading_rate_value', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Shipment::LOADING_RATE_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('loading_rate_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="loading_rate_type_{{ $key }}" name="loading_rate_type" value="{{ $key }}" {{ old('loading_rate_type', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discharging_rate_value') ? 'is-invalid' : '' }}" type="text" name="discharging_rate_value" id="discharging_rate_value" value="{{ old('discharging_rate_value', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Shipment::DISCHARGING_RATE_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('discharging_rate_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="discharging_rate_type_{{ $key }}" name="discharging_rate_type" value="{{ $key }}" {{ old('discharging_rate_type', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('additional_cargo_details') ? 'is-invalid' : '' }}" name="additional_cargo_details" id="additional_cargo_details">{{ old('additional_cargo_details') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('special_requests') ? 'is-invalid' : '' }}" name="special_requests" id="special_requests">{{ old('special_requests') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('freight_idea') ? 'is-invalid' : '' }}" type="text" name="freight_idea" id="freight_idea" value="{{ old('freight_idea', '') }}">
