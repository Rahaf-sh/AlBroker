                            ...
                            columns: [
...

                                {
                                    ...
                                    template: function(row) {
                                        ...
                                        class =
                                            "btn btn-sm btn-clean btn-icon btn-icon-sm btn-view openInNewTap"
                                        data - id = "'+row.id +'"
                                        title = "View" > \
                                            <
                                            i class = "fa fa-eye" > < /i>\ <
                                            /a>\\ <
                                            a href = "#"
                                        data - href = "/reseller/publisher/'+row.id+'/profile"
                                        data - id = "'+row.id+'"
                                        class =
                                            "btn btn-sm btn-clean btn-icon btn-icon-sm btn-edit openInNewTap"\
                                        title = "Edit" > \
                                            <
