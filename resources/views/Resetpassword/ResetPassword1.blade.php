                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ request()->getSchemeAndHttpHost()}}"
                                ...
                                <img width="100" height="100"  src="{{asset('https://cdn.breakthroughbroker.com/assets/bb/imgs/logo_bluesmall.png')}}" class="logo" alt="Laravel Logo"
                            ...
                            <table class="footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <a href="{{ request()->getSchemeAndHttpHost()}}"> © 2021 BROKER. All rights reserved.</a>   
