                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="kt_user_edit_tab_1" role="tabpanel">
                            <form enctype="multipart/form-data" class="form" id="kt_form" method="POST"
                                  action="{{route('brand.update',$data->id)}}">
                                @csrf
                                            ...
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6" >
                                                        <div class="kt-avatar kt-avatar--outline " style="width: 250px;height: 250px"
                                                             id="kt_user_edit_avatar">
                                                            <div class="kt-avatar__holder"
                                                                 style="background-image: url('{{asset($data->media_path)}}');background-size:contain;width: 250px !important"
                                                            ></div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input required
                                                               ...
                                                               name="name_en"
                                                               class="form-control" type="text" value="{{$data->name_en}}">
                                                    </div>
                                                    <label class="col-xl-3"></label>
                                                </div>
                                                {{--Arabic Name--}}
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <input required
                                                               ...
                                                               name="name_ar"
                                                               class="form-control" type="text" value="{{$data->name_ar}}">
                                                    </div>
                                                    <label class="col-xl-3"></label>
                                                </div>
