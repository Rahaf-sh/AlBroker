...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.cargoType.title_singular') }}
    </div>
    <form method="POST" action="{{ route("dashboard.cargo-types.store") }}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            ...
            <div class="cargo-info" style="margin: 0 auto;width:80%;">
                ...
                <div class="form-group row">
                    ...
                    <input class="form-control col-lg-6 col-xl-6{{ $errors->has('name_ar') ? 'is-invalid' : '' }}"
                        type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', '') }}" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-3 col-xl-3">
                    <input required="" name="min_usd" type="number" class="form-control" value="">
                </div>
                <label class="col-xl-1 col-lg-1 col-form-label">Max</label>
                <div class="col-lg-3 col-xl-3">
                    <input required="" name="max_usd" type="number" class="form-control" value="">
                </div>
            ...
            <div class="form-group row">
                ...
                <label class="col-xl-1 col-lg-1 col-form-label">Min</label>
                <div class="col-lg-3 col-xl-3">
                    <input required="" name="min_euro" type="number" class="form-control" value="">
                </div>
                <label class="col-xl-1 col-lg-1 col-form-label">Max</label>
                <div class="col-lg-3 col-xl-3">
                    <input required="" name="max_euro" type="number" class="form-control" value="">
                </div>
                <label class="col-xl-3"></label>
            </div>
