                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="kt_user_edit_tab_1" role="tabpanel">
                            <form enctype="multipart/form-data" class="form" id="kt_form" method="POST"
                                  action="{{route('cargo_type.update',$data->id)}}">
                                @csrf
                                @method('PUT')
                                                ...
                                                <div class="kt-section__body group">
                                                    ...
                                                    <div>
                                                        <input hidden type="text"
                                                               value="{{isset($data->usd)?$data->usd->id:null}}"
                                                               name="usd_id">
                                                    </div>
                                                </div>
                                                <div class="kt-section__body group">
                                                    ...
                                                    <div>
                                                        <input hidden type="text"
                                                               value="{{isset($data->euro)?$data->euro->id:null}}"
                                                               name="euro_id">
                                                    </div>
                                                </div>
                                                <div>
                                                ...
                                                <div class="row d-flex justify-content-center">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <button type="submit"
                                                            ...
                                                            <i class="ki ki-check icon-sm"></i>{{__('dashboard.save')}}
                                                        </button>
...
@section('js')
    <script>
        $(document).ready(function () {
            if (window.location.href === {!! json_encode(url('/')) !!} + "/dashboard/{{$route}}/{{$data->id}}/edit" || window.location.href === {!! json_encode(url('/')) !!} + "/dashboard/{{$route}}/{{$data->id}}/edit/") {
