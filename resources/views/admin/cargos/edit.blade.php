...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('dashboard.cargos.update', [$cargo->id]) }}" enctype="multipart/form-data">
        @method('PUT')
            @csrf
            <div>
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-lg-6 col-xl-6 {{ $errors->has('user') ? 'is-invalid' : '' }}"
                        ...
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $cargo->charter->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('user'))
                ...
                <div class="form-group row">
                    ...
                    <select
                        ...
                        <option value="{{ $id }}" {{ (old('cargo_type_id') ? old('cargo_type_id') : $cargo->cargo_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-xl-4">
                        <input class="form-control{{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="text"
                            name="quantity" id="quantity" value="{{ old('quantity', $cargo->quantity) }}" required>
                    ...
                    <div class="col-lg-5 col-xl-5">
                        <div class="form-check {{ $errors->has('quantity_unit') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="quantity_unit" name="quantity_unit"
                                value="MT" required  {{$cargo->quantity_unit == 'MT'? 'checked' : ''}} >
                            <label class="form-check-label" for="quantity_unit" style="padding-right: 50px;">MT</label>
                            <input class="form-check-input" type="radio" id="quantity_unit" name="quantity_unit"
                                value="CM" required  {{$cargo->quantity_unit == 'CM'? 'checked' : ''}} >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-xl-4">
                        <input class="form-control{{ $errors->has('stowage_factor') ? 'is-invalid' : '' }}" type="text"
                            name="stowage_factor" id="stowage_factor" value="{{ old('stowage_factor', $cargo->stowage_factor) }}" required>
            ...
            <div class="card-footer-border">
                ...
                <div class="form-group row">
                    ...
                    <select
                        ...
                        <option value="{{ $id }}" {{ (old('landing_port_country_id ') ? old('landing_port_country_id ') : $cargo->landing_port_country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            {{ $entry }}
                        </option>
                        @endforeach
                    </select>
                    ...
                    <input class="form-control col-lg-4 col-xl-4" type="text" id="landing_port_name" name="landing_port_name"
                       value="{{ old('landing_port_name', $cargo->landing_port_name) }}" required>
                ...
                <div class="form-group row">
                    ...
                    <select
                        ...
                        <option value="{{ $id }}" {{ (old('discharging_port_country_id') ? old('discharging_port_country_id') : $cargo->discharging_port_country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            {{ $entry }}</option>
                        @endforeach
                    </select>
                    ...
                    <input class="form-control col-lg-4 col-xl-4" type="text" id="discharging_port_name"
                        name="discharging_port_name"  value="{{ old('discharging_port_name', $cargo->discharging_port_name) }}" required>
            ...
            <div class="card-footer-border" >
                ...
                <div class="form-group row">
                    ...
                    <input
                        ...
                        type="text" name="lay_can_start_date" id="lay_can_start_date" value="{{ old('lay_can_start_date', $cargo->lay_can_start_date) }}" required>
                    ...
                    <input
                        ...
                        type="text" name="lay_can_canceling_date" id="lay_can_canceling_date" value="{{ old('lay_can_canceling_date', $cargo->lay_can_canceling_date) }}"
                        required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-xl-4">
                        <input class="form-control{{ $errors->has('loading_rate') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('loading_rate', $cargo->loading_rate) }}" required>
                    ...
                    <div class="col-lg-3 col-xl-3">
                        <div class="form-check {{ $errors->has('loading_rate_unit') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="loading_rate_unit"
                                name="loading_rate_unit" value="MT" required {{$cargo->loading_rate_unit == 'MT'? 'checked' : ''}}>
                            <label class="form-check-label" for="loading_rate_unit"
                                style="padding-right: 50px;">MT/DAY</label>
                            <input class="form-check-input" type="radio" id="loading_rate_unit"
                                name="loading_rate_unit" value="CM" required {{$cargo->loading_rate_unit == 'CM'? 'checked' : ''}}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-xl-4">
                        <input class="form-control{{ $errors->has('discharging_rate') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('discharging_rate',  $cargo->discharging_rate) }}" required>
                    ...
                    <div class="col-lg-3 col-xl-3">
                        <div class="form-check {{ $errors->has('discharging_unit') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="discharging_unit"
                                name="discharging_unit" value="MT" required {{$cargo->discharging_unit == 'MT'? 'checked' : ''}}>
                            <label class="form-check-label" for="discharging_unit"
                                style="padding-right: 50px;">MT/DAY</label>
                            <input class="form-check-input" type="radio" id="discharging_unit"
                                name="discharging_unit" value="CM" required {{$cargo->discharging_unit == 'CM'? 'checked' : ''}}>
            ...
            <div class="card-footer-border">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('additional_cargo_details') ? 'is-invalid' : '' }}"
                        ...
                        >{{ old('additional_cargo_details',$cargo->additional_cargo_details)}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('special_requests') ? 'is-invalid' : '' }}"
                        name="special_requests" id="special_requests">{{ old('special_requests', $cargo->special_requests)}}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3 col-xl-3">
                        <input class="form-control{{ $errors->has('fright_idea') ? 'is-invalid' : '' }}" type="text"
                            name="fright_idea" id="fright_idea" value="{{ old('fright_idea', $cargo->fright_idea) }}" required>
                    ...
                    <div class="col-lg-3 col-xl-3">
                        <div class="form-check {{ $errors->has('fright_idea_unit') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="fright_idea_unit" name="fright_idea_unit"
                                value="$" required {{$cargo->fright_idea_unit == '$'? 'checked' : ''}}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3 col-xl-3">
                        <input class="form-control{{ $errors->has('address_commission') ? 'is-invalid' : '' }}" type="text"
                            name="address_commission" id="address_commission" value="{{ old('address_commission', $cargo->address_commission) }}" required>
