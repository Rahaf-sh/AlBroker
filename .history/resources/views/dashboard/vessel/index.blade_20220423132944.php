                            ...
                            columns: [
                                ...
                                ';
                                      ...
                                      if(row.status =='suspend'){
                                          return '\
                                    \
                                    <a data-href="/reseller/publisher/'+row.id+'/websites"  class="btn btn-sm btn-clean btn-icon btn-icon-sm btn-view openInNewTap" data-id="'+row.id +'" title="View">\
                                        <i class="fa fa-eye"></i>\
                                    </a>\
                                    \
                                    \
                                                <a data-href="/reseller/publisher/'+row.id+'/profile" data-id = "'+row.id+'"  class="btn btn-sm btn-clean btn-icon btn-icon-sm btn-edit openInNewTap"\
                                                  title="Edit">\
                                        <i class="fa fa-edit"></i>\
                                        </a>\
                                ';
